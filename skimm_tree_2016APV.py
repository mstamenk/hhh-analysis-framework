...
parser.add_option("--base_folder ", type="string", dest="base", help="Folder in where to look for the categories", default='/eos/cms/store/group/phys_higgs/cmshhh/v33/mva-inputs-2016APV-categorisation-spanet-boosted-classification/')
# parser.add_option("--base_folder ", type="string", dest="base", help="Folder in where to look for the categories", default='/eos/cms/store/group/phys_higgs/cmshhh/v33-additional-samples/mva-inputs-2016APV-categorisation-spanet-boosted-classification/')
...
for selection in selections.keys() :
  ...
  if not skip_do_correct :
    ...
    for Higgs_number in Higgs_number_strings: 
        ...
        Unc_Shape(file_1Higgs,file_2Higgs,do_limit_input,Higgs_number,path_to_histograms,year)
