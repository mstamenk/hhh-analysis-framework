...
# ROOT.ROOT.DisableImplicitMT()
from utils import histograms_dict, ProbMultiH_cut, wps_years, wps, tags, luminosities, hlt_paths, triggersCorrections, hist_properties, init_mhhh, addMHHH, clean_variables, initialise_df, save_variables, init_get_max_prob, init_get_max_cat, init_get_hand_cat, init_higgs_pair
...
#################3Higgs################
        "Prob3Higgs_inclusive"              : {
        "sel" : "(IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4  )",
        "label" : "Prob3Higgs ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
...
################QCD################
        ...
        "sel" : "(IndexMaxProb == 2 && IndexHandCat == 1  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 2 && IndexHandCat == 2  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 2 && IndexHandCat == 3  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 2 && IndexHandCat == 4  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 2 && (IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 2 && (IndexHandCat == 0 || IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 || IndexHandCat == 8 || IndexHandCat == 9))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
...
#########################TT######################
        ...
        "sel" : "(IndexMaxProb == 3 && IndexHandCat == 1  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 3 && IndexHandCat == 2  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 3 && IndexHandCat == 3  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 3 && IndexHandCat == 4  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 3 && (IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4) )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 3 && (IndexHandCat == 0 || IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 || IndexHandCat == 8 || IndexHandCat == 9))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
...
###############VJets########################
        ...
        "sel" : "(IndexMaxProb == 4 && IndexHandCat == 1  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 4 && IndexHandCat == 2  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 4 && IndexHandCat == 3  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 4 && IndexHandCat == 4  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 4 && (IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4) )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 4 && (IndexHandCat == 0 || IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 || IndexHandCat == 8 || IndexHandCat == 9))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && IndexHandCat == 1  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && IndexHandCat == 2  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && IndexHandCat == 3  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && IndexHandCat == 4  )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && (IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4) )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && (IndexHandCat == 0 || IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 || IndexHandCat == 8 || IndexHandCat == 9))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "ProbHH4b_rest_inclusive"              : {
        "sel" : "(IndexMaxProb == 7 && (IndexHandCat == 0 || IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 || IndexHandCat == 8 || IndexHandCat == 9))",
        "label" : "ProbHH4b_rest_inclusive ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        },
...
#################merge category####################
        "ProbQCD_semi_boosted_inclusive"              : {
        "sel" : "(IndexMaxProb == 2 &&(IndexHandCat ==2 || IndexHandCat ==3 || IndexHandCat ==4))",
        "label" : "ProbQCD_semi_boosted ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        },

        "Probrest_3bh0h_inclusive"              : {
        "sel" : "((IndexMaxProb == 4 || IndexMaxProb == 5)&& IndexHandCat ==1)",
        "label" : "Prob(VV+VJets)_3bh0h ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        },

        "Probrest_semi_boosted_inclusive"              : {
        "sel" : "((IndexMaxProb == 4 || IndexMaxProb == 5)&&(IndexHandCat ==2 || IndexHandCat ==3 || IndexHandCat ==4))",
        "label" : "Prob(VV+VJets)_semi_boosted ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        },

        "Probrest_3Higgs_inclusive"              : {
        "sel" : "((IndexMaxProb == 4 || IndexMaxProb == 5)&&(IndexHandCat == 1 || IndexHandCat ==2 || IndexHandCat ==3 || IndexHandCat ==4))",
        "label" : "Prob(VV+VJets)_semi_boosted ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 1 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 2 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 3 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 4 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 5)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 6)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 7)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 8)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 9)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && IndexHandCat == 0)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 ))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (IndexHandCat == 8 || IndexHandCat == 9 ))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
...
# HH
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 1 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 2 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 3 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 4 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 5)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0  ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 6)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 7)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 8)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 9)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && IndexHandCat == 0)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && (IndexHandCat == 1 || IndexHandCat == 2 || IndexHandCat == 3 || IndexHandCat == 4))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0  ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && (IndexHandCat == 5 || IndexHandCat == 6 || IndexHandCat == 7 ))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0  ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 7 && (IndexHandCat == 8 || IndexHandCat == 9 ))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450 )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 5 && (IndexHandCat == 7))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0. && ht > 450 && (nmediumbtags >= 4 || nprobejets >= 2) )",
        "dataset" : "-weights",
...
for selection in selections.keys() :
  ...
  output_tree = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/cat_new/%s"%(year)
  ...
  if not skip_do_trees :
   ...
   for proctodo in procstodo :
    ...
    for proc in list_proc :
        ...
        chunk_df = ROOT.RDataFrame(inputTree, proc)
        entries_count = chunk_df.Count().GetValue()
        print(f"Processed entries: {entries_count}")
        ...
        #     chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_b_plus_c} > 0.5 && {pnet_b_vs_c} > {cut_jet}) ? 1 : 0")
        #     # chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_b_plus_c} > 0.5 && {pnet_b_vs_c} > 0.70) ? 1 : 0")
        #     # chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_b_plus_c} > 0.5 && {pnet_b_vs_c} > 0.40) ? 1 : 0")
        ...
        # 定义变量名
            ...
            # 添加新的 branch，判断是否满足 Btag 条件
            chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_b} > {cut_jet}) ? 1 : 0")
            print(f"{pass_btag_branch}")
            # chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_b_plus_c} > 0.5 && {pnet_b_vs_c} > 0.70) ? 1 : 0")
            # chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_b_plus_c} > 0.5 && {pnet_b_vs_c} > 0.40) ? 1 : 0")
        ...
        for i in range(1, 4):  # 遍历 fatJet1 到 fatJet4
            ...
            # 添加新的 branch，判断是否满足 Btag 条件
            chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_xbb} > {cut_fatjet}) ? 1 : 0")
            print(f"{pass_btag_branch}")
            # chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_xbb} > 0.90) ? 1 : 0")
            # chunk_df = chunk_df.Define(pass_btag_branch, f"({pnet_xbb} > 0.641) ? 1 : 0")

        ROOT.gInterpreter.GenerateDictionary("vector<Jet>", "Math/Vector4D.h")
        ROOT.gInterpreter.GenerateDictionary("vector<FatJet>", "Math/Vector4D.h")
        ...
        chunk_df = chunk_df.Define("jets_4vec", define_jet)
        print("jets_4vec")
        ...
        # 定义 RDataFrame
        chunk_df = chunk_df.Define("fatjets_4vec", define_fatjet)
        print("fatjets_4vec")
        # chunk_df = chunk_df.Define("higgs_info", "higgsPairing(jets_4vec, fatjets_4vec, 0.0)").Filter("higgs_info.first >= 0.0", "Skip invalid events")
        # chunk_df = chunk_df.Define("h_mass", "higgs_info.first") \
        #         .Define("hhh_mass1", "higgs_info.first * 3") \
        #         .Define("hhh_mass2", "(polarP4(std::get<0>(higgs_info.second[0]), std::get<1>(higgs_info.second[0]), std::get<2>(higgs_info.second[0]), std::get<3>(higgs_info.second[0])) + "
        #                                 "polarP4(std::get<0>(higgs_info.second[1]), std::get<1>(higgs_info.second[1]), std::get<2>(higgs_info.second[1]), std::get<3>(higgs_info.second[1])) + "
        #                                 "polarP4(std::get<0>(higgs_info.second[2]), std::get<1>(higgs_info.second[2]), std::get<2>(higgs_info.second[2]), std::get<3>(higgs_info.second[2]))).M()") \
        #         .Define("h1_pt", "std::get<0>(higgs_info.second[0])") \
        #         .Define("h1_eta", "std::get<1>(higgs_info.second[0])") \
        #         .Define("h1_phi", "std::get<2>(higgs_info.second[0])") \
        #         .Define("h1_mass", "std::get<3>(higgs_info.second[0])") \
        #         .Define("h2_pt", "std::get<0>(higgs_info.second[1])") \
        #         .Define("h2_eta", "std::get<1>(higgs_info.second[1])") \
        #         .Define("h2_phi", "std::get<2>(higgs_info.second[1])") \
        #         .Define("h2_mass", "std::get<3>(higgs_info.second[1])") \
        #         .Define("h3_pt", "std::get<0>(higgs_info.second[2])") \
        #         .Define("h3_eta", "std::get<1>(higgs_info.second[2])") \
        #         .Define("h3_phi", "std::get<2>(higgs_info.second[2])") \
        #         .Define("h3_mass", "std::get<3>(higgs_info.second[2])")

        chunk_df = chunk_df.Define("higgs_info", "higgsPairing(jets_4vec, fatjets_4vec, 0.0)").Filter("std::get<0>(higgs_info) >= 0.0", "Skip invalid events")
        print("higgs_info")

        chunk_df = chunk_df.Define("hhh_mass2", "std::get<0>(higgs_info)") \
        ...
        chunk_df = chunk_df.Define('IndexHandCat', 'get_hand_cat(nFatJetsPassed, nJetsPassed, hhh_mass2)')
        print("IndexHandCat")
        # initialise chunk_df - so we don't need make_selection_rdataframes.py anymore
        print(dataset)
        if 'mvacut0' not in dataset and 'weights' not in dataset:
            chunk_df = initialise_df(chunk_df,year,proc)
            print("initialise_df") # mHHH done inside now
        ...
        chunk_df.Filter("h1_pt<10").Snapshot("Events","try.root")
        print("try")
        ...
        to_save_before = [str(el) for el in chunk_df.GetColumnNames() if 'mva' not in str(el)]
        branches_to_remove = ["jets_4vec", "fatjets_4vec", "higgs_info"]
        to_save_before = [branch for branch in to_save_before if branch not in branches_to_remove]

        to_save = to_save_before + [
