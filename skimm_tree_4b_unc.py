...
for selection in selections.keys() :
  ...
  if not skip_do_correct :
    ...
    path_to_histograms = '%s/run2_separate_4b_unc'%(path_to_histograms_folder)
    ...
    for Higgs_number in Higgs_number_strings: 
        file_1Higgs = "{}/ProbHH4b_{}_inclusive_CR/histograms/histograms_{}.root".format(path_to_histograms,Higgs_number, do_limit_input)
    ...
    if do_run2_bkg:
        ...
        path_run2 = '%s/run2_4b_unc'%(path_to_histograms_folder)
        

        for Higgs_number in Higgs_number_strings: 
            file_1Higgs_run2 = "{}/ProbHH4b_{}_inclusive_CR/histograms/histograms_{}.root".format(path_run2, Higgs_number,do_limit_input)
