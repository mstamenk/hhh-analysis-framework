...
root_files = [f"{path}/GluGluToHHTo4B_cHHH1_TuneCP5_PSWeights_13TeV-powheg-pythia8_tree.root"]
tree_name = "Events"
N_JETS = 10 
N_FJETS = 3 # 选择 jet 数量
...
plt.savefig("corr_4b_mass.pdf", format="pdf", dpi=300, bbox_inches="tight")
