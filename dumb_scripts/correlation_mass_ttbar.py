...
root_files = [f"{path}/TTToHadronic_TuneCP5_13TeV-powheg-pythia8_tree.root", f"{path}/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_tree.root",f"{path}/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_tree.root"]
tree_name = "Events"
N_JETS = 10 
N_FJETS = 3 # 选择 jet 数量
...
plt.savefig("corr_ttbar_mass.pdf", format="pdf", dpi=300, bbox_inches="tight")
