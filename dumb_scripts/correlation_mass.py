...
sns.heatmap(corr_matrix, annot=False, fmt=".2f", cmap="coolwarm", linewidths=0.5, square=True, vmin=-1, vmax=1)
...
plt.savefig("corr_QCD_mass.pdf", format="pdf", dpi=300, bbox_inches="tight")
