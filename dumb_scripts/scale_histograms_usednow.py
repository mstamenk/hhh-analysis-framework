...
# cat_list = ["HHH6b_3bh0h","HHH6b_2bh1h","HHH6b_1bh2h","HHH6b_0bh3h"]
cat_list = ["HHH6b_3bh0h","HHH6b_2bh1h","HHH6b_1bh2h","HHH6b_0bh3h","HHH6b_2bh0h","HHH6b_1bh1h","HHH6b_0bh2h"]

samples_BSM = ['HHHTo6B_c3_0_d4_99',"c3_0_d4_99",'HHHTo6B_c3_0_d4_minus1',"c3_0_d4_m1",'HHHTo6B_c3_19_d4_19',"c3_19_d4_19",'HHHTo6B_c3_1_d4_0',"c3_1_d4_0",'HHHTo6B_c3_1_d4_2',"c3_1_d4_2",'HHHTo6B_c3_2_d4_minus1',"c3_2_d4_m1",'HHHTo6B_c3_4_d4_9',"c3_4_d4_9",'HHHTo6B_c3_minus1_d4_0',"c3_m1_d4_0",'HHHTo6B_c3_minus1_d4_minus1',"c3_m1_d4_m1",'HHHTo6B_c3_minus1p5_d4_minus0p5',"c3_m1p5_d4_m0p5"]
samples_SM  = ["GluGluToHHTo4B_cHHH0","ggHH_kl_0_kt_1","GluGluToHHTo4B_cHHH5","ggHH_kl_5_kt_1","GluGluToHHTo4B_cHHH1","ggHH_kl_1_kt_1","data_obs","GluGluToHHHTo6B_SM","c3_0_d4_0","QCD"]
...
path = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33_new/run2"
for cat in cat_list:
    file_original=ROOT.TFile("%s/Prob%s_inclusive_CR/histograms/histograms_kappa.root"%(path,cat), "READ")
    file_new = ROOT.TFile("%s/Prob%s_inclusive_CR/histograms/histograms_kappa_scale.root"%(path,cat),"RECREATE")
    print("%s"%(cat))
