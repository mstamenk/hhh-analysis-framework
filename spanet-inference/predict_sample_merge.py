...
# path = '/eos/cms/store/group/phys_higgs/cmshhh/%s_ak8_option4_%s/mva-inputs-%s/%s/'%(args.version,args.year,args.year,regime)
# path = '/eos/home-x/xiangran/samples/%s_%s/%s/'%(args.year,args.version,regime)
path = args.inputdir
...
for i in range(len(output_values_class[0])):
    ...
    prob_vjets.append(float(output_values_class[12][i][4]))
    prob_vv.append(float(output_values_class[12][i][5]))
    prob_hhh4b2tau.append(float(output_values_class[12][i][6]))
    prob_hh4b.append(float(output_values_class[12][i][7]))
    prob_hh2b2tau.append(float(output_values_class[12][i][8]))
    #prob_dy.append(float(output_values_class[12][i][9]))
