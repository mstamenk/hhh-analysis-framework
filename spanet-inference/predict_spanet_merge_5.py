...
session_class = onnxruntime.InferenceSession("/afs/cern.ch/user/x/xgeng/public/v34_training/output_xinyue3_model.onnx",sess_options,providers=['CPUExecutionProvider'])
