...
# session = onnxruntime.InferenceSession("/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/spanet-inference/spanet_pnet_all_vars_v0.onnx",sess_options)

session = onnxruntime.InferenceSession("/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/spanet-inference/spanet_pnet_all_vars_v0.onnx",
                                        sess_options,
...
path = '/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/spanet-inference'
path_f_in = path + '/' + '%s.root'%args.f_in
