...
for i in range(len(output_values_class[0])):
    ...
    # prob_tthh.append(float(output_values_class[12][i][5]))
...
# arr_prob_tthh = ROOT.VecOps.AsRVec(np.array(prob_tthh))
...
# df = ROOT.AddArray(ROOT.RDF.AsRNode(df), arr_prob_tthh, "ProbTTHH")
