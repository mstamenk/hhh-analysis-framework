...
session = onnxruntime.InferenceSession("/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/spanet-inference/spanet_categorisation_v6.onnx",
                                        sess_options,
