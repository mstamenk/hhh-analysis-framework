...
syst_list = ["PNetAK4_Stat","PNetAK4_FSR","PNetAK4_zjets_muF","PNetAK4_ISR","PNetAK4_ttbar_muR","PNetAK4_ttbar_muF","PNetAK4_wjets_muR","PNetAK4_wjets_muF","PileUp","l1Prefiring","PNetAK4_zjets_muR","PNetAK4_jetID","PNetAK4_wjets_c_xsec","PNetAK4_zjets_c_xsec"]
...
for year in year_list:
    ...
    path_hist = '/eos/home-x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v34_test/%s'%(year)
    ...
    for cat in cat_list:
        ...
        hist_path_corr = path_hist + '/' + cat + '/' + 'histograms/' +'histograms_ProbMultiH_tthh_fixAsy.root'
        ...
        Hist_tthh_o = file_o.Get("TTHHTo4b").Clone()
        Hist_tthh_o.SetName("TTHHTo4b")
        Hist_tthh = file_o.Get("TTHHTo4b").Clone()
        Hist_tthh.SetName("TTHHTo4b"+ "_" + year)

        Hist_whh_o = file_o.Get("WHHTo4B").Clone()
        Hist_whh_o.SetName("WHHTo4B")
        Hist_whh = file_o.Get("WHHTo4B").Clone()
        Hist_whh.SetName("WHHTo4B"+ "_" + year)

        Hist_zhh_o = file_o.Get("ZHHTo4B").Clone()
        Hist_zhh_o.SetName("ZHHTo4B")
        Hist_zhh = file_o.Get("ZHHTo4B").Clone()
        Hist_zhh.SetName("ZHHTo4B"+ "_" + year)
