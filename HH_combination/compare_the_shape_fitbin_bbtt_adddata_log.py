...
for type in type_list:
    ...
    # path_plots = "/eos/home-x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/HH_combination/plots/bbtt/plots_%s_fitbin_data"%(type)
    if type == "alt2":
        # path_r = "/eos/home-x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/HH_combination/bbtt/new_hist_alt2"
        path_r = "/eos/home-x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/HH_combination/bbtt/new_hist_alt2_scale"
    else:
        # path_r = "/eos/home-x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/HH_combination/bbtt/new_hist_alt"
    ...
    for cat in cat_list:
        for par in particle_list:
            for year in year_list:
                ...
                if log_scale:
                    c1.SaveAs(f"{path_plots}/comparison_{cat}_{par}_{year}_log.pdf")
                else:
