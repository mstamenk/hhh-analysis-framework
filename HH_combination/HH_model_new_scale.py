...
path_for_output = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/HH_combination"

for cat in cat_list:
    for lep in  lep_list:
        for year in year_list:
            file = ROOT.TFile("%s/hh_%s_%s_%s_13TeV.input.root"%(path_for_histograms,cat,lep,year),"READ")
            output_file = ROOT.TFile("%s/new_hist_alt2_scale/hh_%s_%s_%s_13TeV.input.root"%(path_for_output,cat,lep,year), "RECREATE")
            processed_unc = set()
            ...
            for kappa_name, values in kappa_list.items():
                ...
                for basis in reweight_alt2:
                    ...
                    if basis == 'ggHH_kl_5p00_kt_1p00_c2_0p00_hbbhtt':
                        scale_factor = 1.005
                    elif basis == 'ggHH_kl_1p00_kt_1p00_c2_0p00_hbbhtt':
                        scale_factor = 0.996
                    elif basis == 'ggHH_kl_2p45_kt_1p00_c2_0p00_hbbhtt':
                        scale_factor = 1.026
                    elif basis == 'ggHH_kl_0p00_kt_1p00_c2_1p00_hbbhtt':
                        scale_factor = 0.85
                    elif basis == 'ggHH_kl_1p00_kt_1p00_c2_0p35_hbbhtt':
                        scale_factor = 0.85
                    elif basis == 'ggHH_kl_1p00_kt_1p00_c2_3p00_hbbhtt':
                        scale_factor = 0.9
                    elif basis == 'ggHH_kl_0p00_kt_1p00_c2_0p00_hbbhtt':
                        scale_factor = 0.9922
                    ...
                    if combined_histogram is None:
                        ...
                        combined_histogram.Scale(weight*scale_factor)
                    else:
                        # print(basis)
                        # print(weight)
                        hist_temp = hist_basis.Clone()
                        hist_temp.Scale(weight*scale_factor)
                ...
                for key in file.GetListOfKeys():
                    ...
                    if match:
                        ...
                        for base_name in reweight_alt2:
                            if base_name == 'ggHH_kl_5p00_kt_1p00_c2_0p00_hbbhtt':
                                scale_factor = 1.005
                            elif base_name == 'ggHH_kl_1p00_kt_1p00_c2_0p00_hbbhtt':
                                scale_factor = 0.996
                            elif base_name == 'ggHH_kl_2p45_kt_1p00_c2_0p00_hbbhtt':
                                scale_factor = 1.026
                            elif base_name == 'ggHH_kl_0p00_kt_1p00_c2_1p00_hbbhtt':
                                scale_factor = 0.85
                            elif base_name == 'ggHH_kl_1p00_kt_1p00_c2_0p35_hbbhtt':
                                scale_factor = 0.85
                            elif base_name == 'ggHH_kl_1p00_kt_1p00_c2_3p00_hbbhtt':
                                scale_factor = 0.9
                            elif base_name == 'ggHH_kl_0p00_kt_1p00_c2_0p00_hbbhtt':
                                scale_factor = 0.9922
                            ...
                            if combined_up is None:
                                ...
                                combined_up.Scale(weight*scale_factor)
                            else:
                                hist_temp_up = hist_up.Clone()
                                hist_temp_up.Scale(weight*scale_factor)
                            ...
                            if combined_down is None:
                                ...
                                combined_down.Scale(weight*scale_factor)
                            else:
                                hist_temp_down = hist_down.Clone()
                                hist_temp_down.Scale(weight*scale_factor)
