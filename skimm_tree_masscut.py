...
selections = {
    ...
    # Start of SR definition
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 1 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 2 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 3 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 4 )",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 5)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 6)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 7)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0.0 && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 8)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0.0 && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 9)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0.0 && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && IndexMaxCat == 0)",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && (IndexMaxCat == 1 || IndexMaxCat == 2 || IndexMaxCat == 3 || IndexMaxCat == 4))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450  && (passMinPt||passFJMinPt) )",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && (IndexMaxCat == 5 || IndexMaxCat == 6 || IndexMaxCat == 7 ))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0 && ht > 450  && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
        ...
        "sel" : "(IndexMaxProb == 1 && (h1_t3_mass >= 60 && h1_t3_mass <= 180 && h2_t3_mass >= 60 && h2_t3_mass <= 180 && h3_t3_mass >= 60 && h3_t3_mass <= 180) && (IndexMaxCat == 8 || IndexMaxCat == 9 ))",
        "label" : "ProbHHH ",
        "doSR" : "&& ProbMultiH > 0.0 ",
        "doCR" : "&& (ProbMultiH > 0. && ht > 450   && (passMinPt||passFJMinPt))",
        "dataset" : "-weights",
...
for selection in category_list:
  ...
  output_tree = "/eos/cms/store/group/phys_higgs/cmshhh/v34-test/masscut/%s"%(year)
