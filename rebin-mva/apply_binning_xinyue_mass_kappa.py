...
custom_bin_config = {
    'ProbHHH6b_2bh0h_inclusive': (0.9328, 0.02869),
    'ProbHHH6b_3bh0h_inclusive': (0.8495, 0.03542),
    'ProbHHH6b_1bh2h_inclusive': (0.9569, 0.02316),
    'ProbHHH6b_2bh1h_inclusive': (0.9308, 0.01893),
    'ProbHHH6b_0bh3h_inclusive': (0.9769, 0.01046),
    'ProbHHH6b_0bh2h_inclusive': (0.9669, 0.02208),
    'ProbHHH6b_1bh1h_inclusive': (0.9569, 0.02949),
    'ProbHHH6b_1Higgs_inclusive': (0.9358, 0.04187),
    'ProbHHH6b_0bh0h_inclusive': (0.9137, 0.02457),
}
...
# ✅ 构建 binnings 字典：{ category : {1:[low,high], ...} }
binnings = {}
for cat, (x_cut, bin_width) in custom_bin_config.items():
    # 从 (x_cut - 9 * bin_width) 到 x_cut，再加上最后一个 bin 到 1.0
    bin_edges = [round(x_cut - (9 - i) * bin_width, 6) for i in range(9)] + [round(x_cut, 6), 1.0]
...
path = '/eos/cms/store/group/phys_higgs/cmshhh/%s-test/masscut/'%(version)
...
for cat in ['%s_2bh0h_inclusive','%s_1bh1h_inclusive','%s_0bh2h_inclusive','%s_3bh0h_inclusive','%s_2bh1h_inclusive','%s_1bh2h_inclusive','%s_0bh3h_inclusive','%s_1Higgs_inclusive','%s_0bh0h_inclusive']:# variables:
    cat = cat%prob
    print(cat)
    #print(binnings[cat])
    cat_path = cat + option
    ...
    output_path = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v34_mass"
