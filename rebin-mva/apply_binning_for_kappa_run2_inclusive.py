...
custom_bin_config = {
    'ProbHHH6b_0bh3h_inclusive': (0.9977, 0.9980,0.0020066889632106566 ),
    'ProbHHH6b_1bh2h_inclusive': (0.9973, 0.9980,0.0019999495750752565 ),
    'ProbHHH6b_2bh1h_inclusive': (0.9960, 0.9970, 0.0029695769415505986),
    'ProbHHH6b_3bh0h_inclusive': (0.9917,  0.9940,  0.006020066889632081 ),
    'ProbHHH6b_0bh2h_inclusive': (0.9977, 0.9980, 0.0020066889632106566  ),
    'ProbHHH6b_1bh1h_inclusive': (0.9977, 0.9980 , 0.0020066889632106566  ),
    'ProbHHH6b_2bh0h_inclusive': (0.9973,  0.9980, 0.0020066889632106566 ),
    'ProbHHH6b_1Higgs_inclusive': (0.9953, 0.9960 , 0.004013377926421424  ),
    'ProbHHH6b_0bh0h_inclusive': (0.9873,  0.9900,  0.009959146788530517 ),
    # 👉 更多分类继续添加...
}
...
binnings = {}
for cat, (x2_cut, x_cut, bin_width) in custom_bin_config.items():
    bin_edges = [x2_cut, x_cut, 1.0]
    x = x2_cut
    for _ in range(8):
        x -= bin_width
        bin_edges.insert(0, round(x, 6))  # 保留有效数字
