...
path = '/eos/cms/store/group/phys_higgs/cmshhh/%s-test/masscut/%s'%(version,path_year)
...
for cat in ['%s_2bh0h_inclusive','%s_0bh0h_inclusive' ]:# variables:
# for cat in ['%s_3bh0h_inclusive']:# variables:
    ...
    path_output = '/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v34_mass/%s'%(path_year)
