...
do
    ...
    do
        ...
        python3 apply_binning_xinyue_jet_kappa_1.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_2.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_3.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_4.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_5.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
