...
custom_bin_config = {
    'ProbHHH6b_3bh0h_inclusive': (0.8957, 0.01),
    'ProbHHH6b_1bh2h_inclusive': (0.9669, 0.03311),
    'ProbHHH6b_2bh1h_inclusive': (0.9498, 0.03422),
    'ProbHHH6b_0bh3h_inclusive': (0.9779, 0.01188),
    'ProbHHH6b_0bh2h_inclusive': (0.9779, 0.02207),
    'ProbHHH6b_1bh1h_inclusive': (0.7883, 0.05156),
    'ProbHHH6b_1Higgs_inclusive': (0.8074, 0.03845),
}
...
path = '/eos/cms/store/group/phys_higgs/cmshhh/%s-test/jet_couting/'%(version)
...
for cat in ['%s_2bh0h_inclusive','%s_1bh1h_inclusive','%s_0bh2h_inclusive','%s_3bh0h_inclusive','%s_2bh1h_inclusive','%s_1bh2h_inclusive','%s_0bh3h_inclusive','%s_1Higgs_inclusive','%s_0bh0h_inclusive']:# variables:
    ...
    output_path = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v34_jet"
