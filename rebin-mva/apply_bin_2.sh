...
do
    ...
    do
        ...
        python3 apply_binning_xinyue_jet_cat.py --year $year --path_year 2018 --prob $prob --var ProbMultiH  --version v34 --doSyst&
        python3 apply_binning_xinyue_jet_cat.py --year $year --path_year 2017 --prob $prob --var ProbMultiH  --version v34 --doSyst&
        python3 apply_binning_xinyue_jet_cat.py --year $year --path_year 2016 --prob $prob --var ProbMultiH  --version v34 --doSyst&
        python3 apply_binning_xinyue_jet_cat.py --year $year --path_year 2016APV --prob $prob --var ProbMultiH  --version v34 --doSyst&
