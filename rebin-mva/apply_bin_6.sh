...
do
    ...
    do
        ...
        python3 apply_binning_xinyue_jet_kappa_6.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_7.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_8.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
        python3 apply_binning_xinyue_jet_kappa_9.py --doSyst --year $year --prob $prob --var ProbMultiH --version v34  &
