...
custom_bin_config = {
    ...
    'ProbHHH6b_2bh1h_inclusive': (0.9047, 0.04558),
    'ProbHHH6b_0bh3h_inclusive': (0.9769, 0.01),
    'ProbHHH6b_0bh2h_inclusive': (0.9799, 0.02002),
    'ProbHHH6b_1bh1h_inclusive': (0.8987, 0.04075),
    'ProbHHH6b_1Higgs_inclusive': (0.9348, 0.04135),
    'ProbHHH6b_0bh0h_inclusive': (0.7843, 0.03688),
}
...
path = '/eos/cms/store/group/phys_higgs/cmshhh/%s-test/jet_couting_cat/%s'%(version,path_year)
...
for cat in ['%s_3bh0h_inclusive','%s_2bh1h_inclusive','%s_1bh2h_inclusive','%s_0bh3h_inclusive','%s_1bh1h_inclusive','%s_0bh2h_inclusive','%s_1Higgs_inclusive' ]:# variables:
# for cat in ['%s_3bh0h_inclusive']:# variables:
    ...
    path_output = '/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v34_jet_cat/%s'%(path_year)
