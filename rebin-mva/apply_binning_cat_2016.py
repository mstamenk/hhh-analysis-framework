...
parser.add_argument('--path_year', default='2016')
...
for cat in ['%s_3bh0h_inclusive','%s_2bh1h_inclusive','%s_1bh2h_inclusive','%s_0bh3h_inclusive','%s_2bh0h_inclusive','%s_1bh1h_inclusive','%s_0bh2h_inclusive','%s_1Higgs_inclusive','%s_0bh0h_inclusive','%s_3Higgs_inclusive','%s_2Higgs_inclusive','%s_1Higgs_inclusive']:# variables:
