...
# TTToHadronic_TuneCP5_13TeV-powheg-pythia8_tree_3.root
    for sample  in  TTToHadronic_TuneCP5_13TeV-powheg-pythia8_tree_merge_2.root


    do

        python prepare_inclusive_samples_weights_mc.py -v v34 --year 2017 --f_in $path/ttbar_merge_2/$sample &
