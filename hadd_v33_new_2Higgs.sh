...
for str in "${cat_strings[@]}"; do
    for var in "${var_strings[@]}"; do
        ...
        # hadd -f $OUTPUT_DIR/2016_all/ProbHHH6b_${str}_inclusive_CR/histograms/histograms_${var}_fixAsy.root  $OUTPUT_DIR/2016/ProbHHH6b_${str}_inclusive_CR/histograms/histograms_${var}_fixAsy.root $OUTPUT_DIR/2016APV/ProbHHH6b_${str}_inclusive_CR/histograms/histograms_${var}_fixAsy.root
                ...
                hadd -f $OUTPUT_DIR/$year/${type}_2Higgs_inclusive_CR/histograms/histograms_${var}_fixAsy.root  $OUTPUT_DIR/$year/${type}_2bh0h_inclusive_CR/histograms/histograms_${var}_fixAsy.root $OUTPUT_DIR/$year/${type}_1bh1h_inclusive_CR/histograms/histograms_${var}_fixAsy.root $OUTPUT_DIR/$year/${type}_0bh2h_inclusive_CR/histograms/histograms_${var}_fixAsy.root
                # hadd -f $OUTPUT_DIR/$year/${type}_2Higgs_inclusive_CR/histograms/histograms_${var}.root  $OUTPUT_DIR/$year/${type}_2bh0h_inclusive_CR/histograms/histograms_${var}.root $OUTPUT_DIR/$year/${type}_1bh1h_inclusive_CR/histograms/histograms_${var}.root $OUTPUT_DIR/$year/${type}_0bh2h_inclusive_CR/histograms/histograms_${var}.root
            done
        done
    done 
