...
matrix = df.Histo2D(('cm','cm',binx,xmin,xmax,biny,ymin,ymax), 'categorisation','IndexMaxCat2','eventWeight')
...
c.Print('confusion_matrix_%s_%s_%s_%s_categorisation.png'%(typename,year,sample,maxprob))
...
c2.Print('normalised_confusion_matrix_%s_%s_%s_%s_categorisation.png'%(typename,year,sample,maxprob))
