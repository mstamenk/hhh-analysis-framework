...
from utils import init_get_max_cat,init_get_max_prob
import numpy as np
import random
...
cat_cut = {
    'resolved' : "nfatjets == 0" ,
    'boosted'  : "nfatjets > 0"  ,
    'boosted_a' : "nfatjets ==1" ,
    'boosted_b' : "nfatjets ==2" ,
    'boosted_c' : "nfatjets == 3" ,
    'boosted_d' : "nfatjets > 3" ,
}
...
for cat in [args.type]:
    ...
    if args.doMC:
        ...
        if args.type == 'resolved':
            df_higgs = df_higgs.Filter('nfatjets == 0')
        else:
            df_higgs = df_higgs.Filter('nfatjets > 0')
        # df_higgs.Filter(cat_cut[cat])
