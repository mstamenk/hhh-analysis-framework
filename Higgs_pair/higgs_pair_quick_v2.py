...
ROOT.gInterpreter.Declare('''
    ...
    // Higgs pairing 函数
    std::pair<float, std::vector<std::tuple<float, float, float, float>>> higgsPairing(
...
for year in year_list:
    for file in file_list:
        ...
        # df = df.Define("higgs_info", lambda jets, fatjets: higgsPairing(jets, fatjets, XbbWP=0.0), ["jets_4vec", "fatjets_4vec"])
        output_file = ROOT.TFile(f"{output_path}/{year}/{file}.root", "RECREATE")



        # df = df.Define("h_mass", "higgs_info.first") \
        #         .Define("hhh_mass1", "higgs_info.first * 3") \
        #         .Define("hhh_mass2", "(polarP4(higgs_info.second[0][0], higgs_info.second[0][1], higgs_info.second[0][2], higgs_info.second[0][3]) + "
        #                                 "polarP4(higgs_info.second[1][0], higgs_info.second[1][1], higgs_info.second[1][2], higgs_info.second[1][3]) + "
        #                                 "polarP4(higgs_info.second[2][0], higgs_info.second[2][1], higgs_info.second[2][2], higgs_info.second[2][3])).M()") \
        #         .Define("h1_pt", "higgs_info.second[0][0]") \
        #         .Define("h1_eta", "higgs_info.second[0][1]") \
        #         .Define("h1_phi", "higgs_info.second[0][2]") \
        #         .Define("h1_mass", "higgs_info.second[0][3]") \
        #         .Define("h2_pt", "higgs_info.second[1][0]") \
        #         .Define("h2_eta", "higgs_info.second[1][1]") \
        #         .Define("h2_phi", "higgs_info.second[1][2]") \
        #         .Define("h2_mass", "higgs_info.second[1][3]") \
        #         .Define("h3_pt", "higgs_info.second[2][0]") \
        #         .Define("h3_eta", "higgs_info.second[2][1]") \
        #         .Define("h3_phi", "higgs_info.second[2][2]") \
        #         .Define("h3_mass", "higgs_info.second[2][3]")
        ...
        df.Snapshot("Events", f"{output_path}/{year}/{file}.root", all_branches)
