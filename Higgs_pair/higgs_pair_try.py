...
# 1. 加载 ROOT 文件和树
input_file = ROOT.TFile.Open("/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33/2018/ProbHHH6b_3bh0h_inclusive_CR/GluGluToHHHTo6B_SM.root", "READ")
tree = input_file.Get("Events")  # 替换为实际的树名

# 创建输出文件并复制树结构
output_file = ROOT.TFile("/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33/2018/ProbHHH6b_3bh0h_inclusive_CR/GluGluToHHHTo6B_SM_new.root", "RECREATE")
