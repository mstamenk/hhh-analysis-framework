...
year_strings=("2016" "2016APV" "2017" "2018")
# year_strings=("2016_all" "2017" "2018")
# year_strings=("marko_2018")
...
for str in "${cat_strings[@]}"; do
    for var in "${var_strings[@]}"; do
        ...
        # hadd -f $OUTPUT_DIR/2016_all/ProbHHH6b_${str}_inclusive_CR/histograms/histograms_${var}_fixAsy.root  $OUTPUT_DIR/2016/ProbHHH6b_${str}_inclusive_CR/histograms/histograms_${var}_fixAsy.root $OUTPUT_DIR/2016APV/ProbHHH6b_${str}_inclusive_CR/histograms/histograms_${var}_fixAsy.root
                ...
                # hadd -f $OUTPUT_DIR/$year/${type}_1Higgs_inclusive_CR/histograms/histograms_${var}_fixAsy.root  $OUTPUT_DIR/$year/${type}_1bh0h_inclusive_CR/histograms/histograms_${var}_fixAsy.root $OUTPUT_DIR/$year/${type}_0bh1h_inclusive_CR/histograms/histograms_${var}_fixAsy.root 
                hadd -f $OUTPUT_DIR/$year/${type}_1Higgs_inclusive_CR/histograms/histograms_${var}.root  $OUTPUT_DIR/$year/${type}_1bh0h_inclusive_CR/histograms/histograms_${var}.root $OUTPUT_DIR/$year/${type}_0bh1h_inclusive_CR/histograms/histograms_${var}.root 
                # hadd -f $OUTPUT_DIR/$year/${type}_3Higgs_inclusive_CR/histograms/histograms_${var}.root  $OUTPUT_DIR/$year/${type}_3bh0h_inclusive_CR/histograms/histograms_${var}.root $OUTPUT_DIR/$year/${type}_2bh1h_inclusive_CR/histograms/histograms_${var}.root $OUTPUT_DIR/$year/${type}_1bh2h_inclusive_CR/histograms/histograms_${var}.root $OUTPUT_DIR/$year/${type}_0bh3h_inclusive_CR/histograms/histograms_${var}.root
            done
        done
    done 
