...
path = '/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33/Marko_sample'
cat_list=  ["ProbHHH6b_0bh0h_inclusive_CR","ProbHHH6b_3Higgs_inclusive_CR","ProbHHH6b_2Higgs_inclusive_CR","ProbHHH6b_1Higgs_inclusive_CR","ProbHHH6b_3bh0h_inclusive_CR","ProbHHH6b_2bh1h_inclusive_CR","ProbHHH6b_1bh2h_inclusive_CR","ProbHHH6b_0bh3h_inclusive_CR"]
pro_list = ["GluGluToHHHTo4B2Tau_SM","GluGluToHHHTo6B_SM","GluGluToHHTo4B_cHHH1"]
syst_list = ["PNetAK4_Stat","PNetAK4_FSR","PNetAK4_zjets_muF","PNetAK4_ISR","PNetAK4_ttbar_muR","PNetAK4_ttbar_muF","JES","PNetAK4_wjets_muR","PNetAK4_wjets_muF","JER","JMR","PileUp","l1Prefiring"]
other_syst = ["MUR","MUF","PNetAK8"]
for cat in cat_list:
    ...
    Hist_4B2Tau.SetName("GluGluToHHHTo4B2Tau_SM")
    Hist_6b = file_o.Get("GluGluToHHHTo6B_SM").Clone()
    Hist_6b.SetName("GluGluToHHHTo6B_SM")
    Hist_4b = file_o.Get("GluGluToHHTo4B_cHHH1").Clone()
    Hist_4b.SetName("GluGluToHHTo4B_cHHH1")
    ...
    for pro in pro_list:
        for syst in syst_list:
            ...
            Hist_up    = Hist_nom.Clone(Hist_nom.GetName() + '_' + syst + '_Up') # clone the histogram from nominal
        ...
        for syst in other_syst:
            ...
            Hist_up    = file_o.Get("%s_%s_Up"%(pro,syst)) # clone the histogram from nominal
            Hist_down  = file_o.Get("%s_%s_Down"%(pro,syst))
            Hist_up.Write()
            Hist_down.Write()
            code_for_plot(Hist_up,Hist_down,Hist_nom,pro,syst,path_for_plot)
