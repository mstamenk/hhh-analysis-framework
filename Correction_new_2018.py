...
def Unc_Shape(higgs1_path,higgs2_path,do_limit_input,path,Higgs_number,year):
    ...
    Hist_Data_1Higgs = file_1Higgs.Get("data_obs_2018").Clone()
    Hist_Data_1Higgs.SetName("Hist_Data_1Higgs")
    Hist_Data_2Higgs = file_2Higgs.Get("data_obs_2018").Clone()
    Hist_Data_2Higgs.SetName("data_obs")

    Hist_BKG_1Higgs = file_1Higgs.Get("QCD_2018").Clone()
    Hist_BKG_1Higgs.SetName("Hist_BKG_1Higgs")
    Hist_BKG_2Higgs = file_2Higgs.Get("QCD_2018").Clone()
    Hist_BKG_2Higgs.SetName("QCD")
...
########QCD already scaled to the data, if not you can use line below
    # Hist_BKG_2HiggsOT.TFile(higgs2_path, "update")
...
#######  Hist_Corr_2Higgs_M is histograms down
    ...
    Hist_Data_2Higgs.Write()
    Hist_BKG_2Higgs.Write()
    f_out.Close()
