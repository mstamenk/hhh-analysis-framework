...
# path = '/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33/%s'%(year)
    ...
    for pro in pro_list:
        for syst in syst_list:
            ...
            try:
                ...
                Hist_down = None
                print("%s %s %s_%s_Down" % (path,cat,pro, syst))


            Hist_down.SetName(pro + "_" + syst + '_Down')
            if pro == "GluGluToHHHTo6B_SM" or pro == "GluGluToHHTo4B_cHHH1":
                if syst in ["JES","JER","JMR"]:
                    Hist_down.SetName(pro + "_" + syst  + '_Down')
                    Hist_up.SetName(pro + "_"  + syst  + '_Up')
