...
# cat = 'ProbHH4b'
option = '_CR'
# btag_cut_strings = ['%s_2bh0h_inclusive%s','%s_1bh1h_inclusive%s','%s_0bh2h_inclusive%s','%s_3bh0h_inclusive%s','%s_2bh1h_inclusive%s','%s_1bh2h_inclusive%s','%s_0bh3h_inclusive%s','%s_0bh0h_inclusive%s','%s_1Higgs_inclusive%s','%s_1bh0h_inclusive%s','%s_0bh1h_inclusive%s']
