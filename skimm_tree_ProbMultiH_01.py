...
parser = OptionParser()
parser.add_option("--base_folder ", type="string", dest="base", help="Folder in where to look for the categories", default='/eos/cms/store/group/phys_higgs/cmshhh/mva-inputs-2018-categorisation-spanet-boosted-classification')
...
###############VJets########################
        ...
        "sel" : "(IndexMaxProb == 7 && (IndexMaxCat == 0 || IndexMaxCat == 5 || IndexMaxCat == 6 || IndexMaxCat == 7 || IndexMaxCat == 8 || IndexMaxCat == 9))",
...
#################merge category####################
        ...
        "sel" : "(IndexMaxProb == 2 &&(IndexMaxCat ==2 || IndexMaxCat ==3 || IndexMaxCat ==4))",
        ...
        "sel" : "((IndexMaxProb == 4 || IndexMaxProb == 5)&& IndexMaxCat ==1)",
        ...
        "sel" : "((IndexMaxProb == 4 || IndexMaxProb == 5)&&(IndexMaxCat ==2 || IndexMaxCat ==3 || IndexMaxCat ==4))",
        ...
        "sel" : "((IndexMaxProb == 4 || IndexMaxProb == 5)&&(IndexMaxCat == 1 || IndexMaxCat ==2 || IndexMaxCat ==3 || IndexMaxCat ==4))",
        "label" : "Prob(VV+VJets)_semi_boosted ",
        "doSR" : "&& ProbHHH > 0.0 ",
        "doCR" : "&& (ProbHHH > 0.2)",
        "dataset" : "-weights",
...
# procstodo = ["GluGluToHHTo4B_cHHH1","data_obs","GluGluToHHHTo6B_SM","QCD","GluGluToHHHTo4B2Tau_SM","GluGluToHHTo2B2Tau_SM","GluGluToHHHTo6B_SMJERDOWN","GluGluToHHHTo6B_SMJERUP","GluGluToHHHTo6B_SMJESDOWN","GluGluToHHHTo6B_SMJESUP","GluGluToHHHTo6B_SMJMRDOWN","GluGluToHHHTo6B_SMJMRUP","GluGluToHHTo4B_cHHH1JERDOWN","GluGluToHHTo4B_cHHH1JERUP","GluGluToHHTo4B_cHHH1JESDOWN","GluGluToHHTo4B_cHHH1JESUP","GluGluToHHTo4B_cHHH1JMRDOWN","GluGluToHHTo4B_cHHH1JMRUP"]
procstodo = ["GluGluToHHTo4B_cHHH1","data_obs","GluGluToHHHTo6B_SM","QCD","GluGluToHHHTo4B2Tau_SM","GluGluToHHTo2B2Tau_SM"]
...
for selection in selections.keys() :
  ...
  output_tree = "/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33_newtrain/%s"%(year)
    ...
    for var in variables: # booking all variables to be produced
        ...
        if do_limit_input == var :
            ...
            if do_limit_input == 'ProbMultiH':
                nameout = output_histos + '/' + 'histograms_%s_01.root'%(do_limit_input)
  ...
  if not skip_do_plots :
    ...
    #   year = 'run2'
      year = '2018'
      path_to_plots = '/eos/user/x/xgeng/workspace/HHH/CMSSW_12_5_2/src/hhh-analysis-framework/output/v33_newtrain/%s'%(year)
      ...
      command = "python3 draw_data_mc_categories.py --log --input_folder %s --plot_label '%s (%s)' --output_folder %s" % (output_histos.replace('histograms',''), selections[selection]["label"], additional_label,output_folder_draw)
